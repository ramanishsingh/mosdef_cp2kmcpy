...
def mc_files(instance):
    ...
    mySim.FORCE_EVAL.SUBSYS.CELL.ABC = "{a} {b} {c}".format(
        a=10 * round(box_list[0].lengths[0],4), b=10 * round(box_list[0].lengths[1], 4), c=10 * round(box_list[0].lengths[2],4)
    )
    ...
    print(mySim.FORCE_EVAL.SUBSYS.CELL.ABC, "THIS IS ABC")
    ...
    if run_type=='equilibration':
        ...
        mySim.MOTION.MC.MOVE_UPDATES.IUPTRANS =10
        mySim.MOTION.MC.MOVE_UPDATES.IUPVOLUME= 10
    elif run_type=='production':
        mySim.MOTION.MC.MOVE_UPDATES.IUPTRANS =100000
        mySim.MOTION.MC.MOVE_UPDATES.IUPVOLUME= 100000
    else:
...
#writing box 2 file
    ...
    mySim.FORCE_EVAL.SUBSYS.CELL.ABC = "{a} {b} {c}".format(
        a=10 * np.format_float_positional(box_list[1].lengths[0]), b=10 * np.format_float_positional(box_list[1].lengths[1]), c=10 * np.format_float_positional(box_list[1].lengths[2])
    )
    mySim.FORCE_EVAL.SUBSYS.CELL.ALPHA_BETA_GAMMA = "{a} {b} {c}".format(
        a=box_list[1].angles[0], b=box_list[1].angles[1], c=box_list[1].angles[2]
    )
    mySim.FORCE_EVAL.SUBSYS.CELL.CELL_REF.ABC="{a} {b} {c}".format(
        a=10 * np.format_float_positional(box_list[1].lengths[0], 4), b=10 * np.format_float_positional(box_list[1].lengths[1], 4), c=10 * np.format_float_positional(box_list[1].lengths[2], 4)
    )


    #print("ABC", box_list[1].lengths[0])
    #print(type(box_list[1].lengths[0]))
    #print(mySim.FORCE_EVAL.SUBSYS.CELL.ABC, "THIS IS ABC", np.format_float_positional(box_list[1].lengths[0]))
